...
<body>
    ...
    <div class="relative">
        <div class="w-full flex justify-center items-center mt-4">
            <img src="{{ asset('assets/images/event-bg.png') }}" alt="event background" class="object-cover">
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            @forelse($events as $event)
                <div class="bg-white rounded-lg overflow-hidden shadow-lg border border-gray-100 hover:shadow-xl transition duration-300">
                    <img class="w-full h-48 object-cover" src="{{ $event->image_url ?? asset('assets/images/default_event.png') }}" alt="{{ $event->title }}">
