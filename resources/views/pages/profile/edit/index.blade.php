...
<body class="min-h-screen">
    ...
    <div class="max-w-4xl mx-auto p-4 sm:p-8">
        <h1 class="text-3xl font-extrabold text-gray-900 mb-6 pb-2">Edit Profil</h1>
        ...
        <form action="{{ route('updateProfile') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
            ...
            <section class="bg-white p-6 rounded-xl shadow-lg border border-gray-200">
                <h2 class="text-2xl font-semibold text-gray-800 mb-5 pb-3">Informasi Dasar</h2>
            ...
            <section class="bg-white p-6 rounded-xl shadow-lg border border-gray-200">
                <h2 class="text-2xl font-semibold text-gray-800 mb-5 pb-3">Foto Profil & Background</h2>
            ...
            <!-- Bagian 3: Skills -->
            <section class="bg-white p-6 rounded-xl shadow-lg border border-gray-200">
                <h2 class="text-2xl font-semibold text-gray-800 mb-5 pb-3">Skills</h2>
                ...
                <button type="button" onclick="addSkillInput()" 
                        class="mt-4 inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-[#7E794B] hover:bg-[#6e6a3f] focus:outline-none transition duration-150 ease-in-out cursor-pointer">
                    Tambah Skill
                </button>
            </section>
            ...
            <!-- Bagian 4: Edukasi -->
            <section class="bg-white p-6 rounded-xl shadow-lg border border-gray-200">
                <h2 class="text-2xl font-semibold text-gray-800 mb-5 pb-3">Edukasi</h2>
            ...
            <section class="bg-white p-6 rounded-xl shadow-lg border border-gray-200">
                <h2 class="text-2xl font-semibold text-gray-800 mb-5 pb-3">Pengalaman</h2>
    ...
    <script>
        ...
        function addSkillInput() {
            ...
            newDiv.innerHTML = `
                <input type="text" name="skills[]" placeholder="Nama Skill Baru" 
                        class="flex-grow border-gray-300 rounded-lg shadow-sm focus:border-indigo-500 focus:ring-indigo-500 p-2.5">
                <button type="button" onclick="this.parentNode.remove()" 
                        class="text-red-600 hover:text-red-800 text-sm font-medium py-2 px-3 transition duration-150 ease-in-out rounded-lg hover:bg-red-50 cursor-pointer">Hapus</button>
            `;
        ...
        function addEducationInput() {
            ...
            newDiv.innerHTML = `
                ...
                <button type="button" onclick="removeEducationInput(this)" class="absolute top-2 right-2 text-red-500 hover:text-red-700 p-1 rounded-full transition duration-150 ease-in-out cursor-pointer">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg>
                </button>
            `;
            container.appendChild(newDiv);
        ...
        function addExperienceInput() {
            ...
            newDiv.innerHTML = `
                ...
                <button type="button" onclick="removeExperienceInput(this)" class="absolute top-2 right-2 text-red-500 hover:text-red-700 p-1 rounded-full transition duration-150 ease-in-out cursor-pointer">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg>
                </button>
            `;
            container.appendChild(newDiv);
